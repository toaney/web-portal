  ...
  return (
    <div className="w-full h-full px-14 flex flex-col">
      <div className="flex justify-between">
        <div>
          <div className="mt-3.5 text-[#616161] text-[10px] font-normal">{deconstructPath(currentPath)}</div>
          <h1 className="mb-8 text-black text-[40px] font-bold">{prettify(params.id)}</h1>
        </div>
        <div className="flex flex-col justify-center underline text-[#1D29A2]">
          Text Link
        </div>
      </div>
      <div className={`flex border-b-[1px] ml-[20px] pl-[50px] pb-8 mb-8 border-[#E1E1E1] items-center`}>
      ...
      <form className={`flex flex-col ml-[20px]`}>
        <div className={`flex flex-row w-[100%]`}>
          <div className={`w-[55%]`}>
            <div>
              ...
              <div className={`flex mb-[13px]`}>
                <fieldset>
                  <label htmlFor="uniqueId" className={`inline-block text-right w-[145px] text-base pr-3`}>UNIQUE ID</label>
                  <input type="text" key="uniqueId2" id="uniqueId" value={formData.uniqueId.newValue ? formData.uniqueId.newValue : formData.uniqueId.oldValue} onChange={(e) => handleFormUpdate("uniqueId", e.target.value)} className={`w-[144px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.uniqueId.oldValue && !formData.uniqueId.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}/>
                </fieldset>
                <fieldset>
                  <label htmlFor="altId" className={`inline-block pl-8 pr-3`}>ALT ID</label>
                  <input type="text" key="altId" id="altId" value={formData.altId.newValue ? formData.altId.newValue : formData.altId.oldValue} onChange={(e) => handleFormUpdate("altId", e.target.value)} className={`w-[144px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.altId.oldValue && !formData.altId.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}}`}/>
                </fieldset>
              </div>
              <fieldset className={`mb-[13px]`}>
                <label htmlFor="dln" className={`inline-block text-right w-[145px] pr-3`}>DLN</label>
                <input type="text" id="dln" value={formData.dln.newValue ? formData.dln.newValue : formData.dln.oldValue} onChange={(e) => handleFormUpdate("dln", e.target.value)} className={`w-[144px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.dln.oldValue && !formData.dln.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}/>
              </fieldset>
              <fieldset className={`mb-[13px]`}>
                <label htmlFor="lastName" className={`inline-block text-right w-[145px] pr-3`}>LAST NAME</label>
                <input type="text" id="lastName" value={formData.lastName.newValue ? formData.lastName.newValue : formData.lastName.oldValue} onChange={(e) => handleFormUpdate("lastName", e.target.value.toUpperCase())} className={`w-[294px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.lastName.oldValue && !formData.lastName.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}/>
              </fieldset>
              <fieldset className={`mb-[13px]`}>
                <label htmlFor="givenName" className={`inline-block text-right w-[145px] pr-3`}>GIVEN NAME</label>
                <input type="text" id="givenName" value={formData.givenName.newValue ? formData.givenName.newValue : formData.givenName.oldValue} onChange={(e) => handleFormUpdate("givenName", e.target.value.toUpperCase())} className={`w-[294px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.givenName.oldValue && !formData.givenName.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}/>
              </fieldset>
              <fieldset className={`flex mb-[13px] items-center`}>
                <label htmlFor="gender" className={`inline-block text-right w-[145px] pr-3`}>GENDER</label>
                <select id="gender" className={`bg-[#E1E1E1] bg-opacity-60 w-[112px] h-[34px] px-[1px] border-[1px] border-[#E1E1E1] rounded flex justify-between items-center`}>
          ...
          <div>
            <div className={`mb-[70px]`}>
              ...
              <fieldset className={`flex mb-[13px] items-center`}>
                <label htmlFor="street" className={`inline-block text-right w-[145px] pl-8 pr-3`}>STREET</label>
                <input type="text" id="street" value={formData.street.newValue ? formData.street.newValue : formData.street.oldValue} onChange={(e) => handleFormUpdate("street", e.target.value.toUpperCase())} className={`w-[316px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.street.oldValue && !formData.street.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}/>
              </fieldset>
              <fieldset className={`flex mb-[13px] items-center`}>
                <label htmlFor="city" className={`inline-block text-right w-[145px] pr-3`}>CITY</label>
                <input type="text" id="city" value={formData.city.newValue ? formData.city.newValue : formData.city.oldValue} onChange={(e) => handleFormUpdate("city", e.target.value.toUpperCase())} className={`w-[316px] h-8 px-2 border-[1px] border-[#E1E1E1] rounded ${formData.city.oldValue && !formData.city.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}/>
              </fieldset >
              <div className={`flex`}>
                <fieldset className={`flex mb-[13px] items-center`}>
                  <label htmlFor="state" className={`inline-block text-right w-[145px] text-base pr-3`}>STATE</label>
                  <select id="state" className={`inline-block w-[112px] h-[34px] px-[1px] border-[1px] border-[#E1E1E1] rounded flex justify-between items-center ${formData.state.oldValue && !formData.state.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}>
              ...
              <fieldset className={`flex mb-[13px] items-center`}>
                <label htmlFor="country" className={`inline-block text-right w-[145px] pr-3`}>COUNTRY</label>
                <select id="country" className={`w-[259px] h-[34px] border-[1px] border-[#E1E1E1] rounded flex justify-between items-center ${formData.country.oldValue && !formData.country.newValue ? 'bg-[#E1E1E1] bg-opacity-60' : 'bg-white'}`}>
        ...
        <div className={`flex-col`}>
          ...
          <div className={`flex flex-row mb-[60px]`}>
            ...
            <fieldset className={`flex items-center`}>
              {/* <Label>Date</Label> */}
              <label htmlFor="letterDate" className={`inline-block text-right w-[145px] pr-3`}>DATE</label>
              <DatePicker className={`flex h-[34px] border rounded px-2 pt-[3px]`} id="letterDate">
                <Group className={`flex w-[140px] justify-between`}>
